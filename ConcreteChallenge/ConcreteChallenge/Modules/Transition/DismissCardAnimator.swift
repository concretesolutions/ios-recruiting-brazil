...
final class DismissCardAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let screens: (cardDetail: MovieDescriptionInterface, home: HomeInterface) = (
            ctx.viewController(forKey: .from)! as! MovieDescriptionInterface,
            ctx.viewController(forKey: .to)! as! HomeInterface
        )
